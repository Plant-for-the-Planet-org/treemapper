      ...
      <View style={styles.container}>
        <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
          <Header
            ...
            subHeadingText={
              'You can find incomplete registrations on Tree Inventory'
            }
          />
          <LargeButton
            onPress={onPressSingleTree}
            heading={'Single Tree'}
            subHeading={'Allows high precision measurements'}
            active={treeType == 'single'}
          />
          <LargeButton
            onPress={onPressMultipleTree}
            heading={'Multiple Trees'}
            subHeading={'Add many trees with different counts'}
