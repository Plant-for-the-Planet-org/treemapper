      ...
      <Modal animationType={'slide'} visible={isAlrightyModalShow}>
        <View style={styles.cont}>
          <Alrighty
            ...
            heading={'Alrighty'}
            subHeading={`lets go to the first location click the continue when ready`}
          />
        </View>
      </Modal>
    );
      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <LargeButton
            ...
            heading={'On Site (Preferred)'}
            subHeading={
              'Collects Polygon and Images for high accuracy and verifiability '
            }
          ...
          <LargeButton
            ...
            heading={'Off Site'}
            subHeading={
              'Collects Polygon. Best to use when registering from office.'
            }
            active={locateTree == 'off-site'}
          />
          <LargeButton
            onPress={onPressSelectCoordinates}
            heading={'Select Coordinates'}
