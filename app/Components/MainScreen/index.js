...
const MainScreen = ({navigation}) => {
  ...
  let rightIcon = (
    <Icon size={40} name={'play-circle'} color={Colors.GRAY_LIGHTEST} />
  );
        ...
        <ScrollView
          ...
          <ImageBackground
            ...
            <LargeButton
              ...
              heading={'Tree Inventory'}
              active={false}
              subHeading={'of draft and pending registrations'}
          ...
          <ImageBackground
            ...
            <LargeButton
              ...
              style={styles.customStyleLargeBtn}
              heading={'Download Maps'}
              active={false}
              subHeading={'for offline use'}
            />
          </ImageBackground>
          <ImageBackground
            id={'learnbtn'}
            ...
            <LargeButton
              ...
              heading={'Learn'}
              active={false}
              subHeading={'how to use Tree Mapper'}
            />
          </ImageBackground>
        </ScrollView>
        <PrimaryButton
