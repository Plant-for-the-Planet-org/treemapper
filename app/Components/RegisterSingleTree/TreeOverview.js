...
const SingleTreeOverview = ({navigation}) => {
  ...
  useEffect(() => {
    let data = {
      ...
      last_screen: 'SingleTreeOverview',
    };
    ...
    const unsubscribe = navigation.addListener('focus', () => {
      getInventory({inventoryID: state.inventoryID}).then(inventory => {
        ...
        setPLantationDate(
          new Date(Number(inventory.plantation_date)).toLocaleDateString(),
        );
      });
    });
  }, [navigation, state.inventoryID]);
      ...
      coords && (
        <View style={styles.detailSubContainer}>
          <View>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.detailText}>
                {new Date(plantationDate).toLocaleDateString()}{' '}
          ...
          <View>
            ...
            <Text style={styles.detailText}>
              {`${coords.latitude.toFixed(5)}˚N,${coords.longitude.toFixed(
                5,
              )}˚E`}{' '}
            </Text>
          </View>
