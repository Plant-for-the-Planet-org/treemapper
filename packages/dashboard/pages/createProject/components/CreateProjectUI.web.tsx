...
export function CreateProjectUI() {
  ...
  const updateGeoJSON = async (g: any) => {
    setFormData(prev => ({
      ...prev,
      geoJSON: g
    }));
      ...
      <div className="bg-white rounded-lg shadow-md p-4 md:p-6 lg:p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="Number of tress to plant, area to restore, etc."
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            {/* Map Placeholder */}
            <div className="w-full h-64 md:h-80 lg:h-96 bg-red-100 rounded-lg flex items-center justify-center">
              <ProjectSelectMap updateGeoJSON={updateGeoJSON} />
            </div>
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={!agreeTerms}
              style={{ backgroundColor: agreeTerms ? "#007A49" : "#A0AEC0" }}
