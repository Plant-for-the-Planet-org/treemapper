...
import UnifiedMapComponent from './web/ProjectSelectMap'; // Your unified map component
import GeoJSONUpload, { calculateFarmArea, getLatLonFromGeoJSON } from './web/GeoJSONfileupload';
import { toast } from 'react-toastify';
import { createNewProject } from '../../../api/api.fetch'; // Adjust the import path as necessary
