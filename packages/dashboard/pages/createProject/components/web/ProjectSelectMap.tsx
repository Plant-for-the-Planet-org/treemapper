...
const UnifiedMapComponent = ({ updateGeoJSON, uploadedGeoJSON }: Props) => {
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3">
            ...
            <div className="w-full sm:w-auto self-end mt-4 sm:mt-0">
              <button
                ...
                type="button"
                className="w-full sm:w-auto bg-green-800 text-white border-none py-1 px-3 rounded text-sm cursor-pointer hover:bg-blue-600 transition-colors"
              >
                Set Location
              </button>
            </div>
