...
export type SIDE_DRAWER_ELEMENTS = 'logout' | 'manage_species' | 'manage_projects' | 'additional_data' | 'offline_map' | 'data_explorer' | 'activity_log' | 'inventory' | 'language' | 'delete'
...
export type PLOT_STATUS = "INIT" | "SYNCED" | "UPLOAD_PLOT" | "UPDATE_PLOT" 
export type PLOT_PLANT_SYNC_STATUS = "INIT" | "SYNCED" | "UPLOAD_REQUIRED" | 'EDITED'
export type PLOT_OBSERVATION_SYNC_STATUS = "INIT" | "SYNCED" | "UPLOAD_REQUIRED" | 'EDITED'
export type PLOT_GROUP_SYNC_STATUS = "INIT" | "SYNCED" | "UPLOAD_REQUIRED" | 'EDITED'
