...
// } from 'src/utils/constants/functions';
import ElementSwitcher from './ElementSwitcher';
import { version } from '../../../package.json';
// import {LogTypes}  from 'src/utils/constants/appConstant';
import { marginTop24 } from 'src/utils/constants/design';
import PrimaryButton from 'src/components/common/PrimaryButton';
// import { InventoryContext } from '../../reducers/inventory'; Code Migration
// import { getForms, getMetadata } from '../../repositories/additionalData';
// import { INCOMPLETE_SAMPLE_TREE, MULTI, SINGLE } from 'src/utils/constants/inventoryConstants';
// import { getInventory, updateInventory, updateLastScreen } from '../../repositories/inventory'; Code Migration
// import { addAdditionDataToPlantLocationHistory } from '../../repositories/plantLocationHistory'; Code Migration
...
const AdditionalDataForm = () => {
  ...
  const [loadingText] = useState<string>(i18next.t('label.loading_form'));
  const [headingText] = useState<string>(i18next.t('label.additional_data'));
