          ...
          <View style={styles.wrapper}>
            <TouchableOpacity
              ...
              <Text style={styles.keyLabel}>
                {i18next.t('label.input_element')}
              </Text>
              <View style={styles.bodyWrapper}>
                <Text style={styles.inputWrapper}>{elementDetails.label}</Text>
              </View>
            </TouchableOpacity>
          </View>
        )
        ...
        return (
          <View style={styles.wrapper}>
            <TouchableOpacity
              ...
              onPress={editSelection}>
              <Text style={styles.keyLabel}>
                {i18next.t('label.yes_no_element')}
              </Text>
              <View style={styles.bodyWrapper}>
        ...
        return (
          <View style={styles.wrapper}>
            <TouchableOpacity
              ...
              onPress={editSelection}>
              <Text style={styles.keyLabel}>
                {i18next.t('label.heading_element')}
              </Text>
              <View style={styles.bodyWrapper}>
                <Text style={styles.inputWrapper}>
        ...
        return (
          <View style={styles.wrapper}>
            <TouchableOpacity
              ...
              onPress={editSelection}>
              <Text style={styles.keyLabel}>
                {i18next.t('label.dropdown_element')}
              </Text>
              <Dropdown
