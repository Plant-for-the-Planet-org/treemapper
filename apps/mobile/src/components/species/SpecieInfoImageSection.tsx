...
const SpecieInfoImageSection = (props: Props) => {
  const { image, editable } = props.item
    ...
    <View style={styles.container}>
      {image === '' ? (
        ...
        <View style={styles.imageContainer}>
          <ExpoImage.Image
            source={{
              uri: props.item.image.includes('/') ? `${props.item.image}` : `https://pub-261389c3bd084eb3a62686b2f08ce42b.r2.dev/development/species/${props.item.image}`,
            }}
            style={styles.imageView}
            contentFit="cover"
          />
         {editable && <View style={styles.imageControls}>
