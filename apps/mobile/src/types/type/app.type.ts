...
export type SIDE_DRAWER_ELEMENTS = 'logout' | 'manage_species' | 'manage_projects' | 'additional_data' | 'offline_map' | 'data_explorer' | 'activity_log' | 'inventory' | 'language' | 'delete' | 'guide' | 'notification' | 'features' | 'feedback' | 'forms' | 'intervention_tour' | 'analytics_consent' | 'rate_app'
...
export type HISTORY_STATUS =  "SYNCED" |  "REMEASUREMENT_DATA_UPLOAD" | "REMEASUREMENT_EVENT_UPDATE" | "SKIP_REMEASUREMENT"
...
export type OBSERVATION_TYPE = "CANOPY" | "SOIL_MOISTURE" | "BIOACOUSTICS" | "PLOT_DESCRIPTION" | "GRASS_COVER"
export type MAP_VIEW = "SATELLITE" | "VECTOR"
export type TREE_RE_STATUS = "flood" | "fire" | "drought" | "other" | "disease"
