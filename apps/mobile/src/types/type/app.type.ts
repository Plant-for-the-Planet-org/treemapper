...
export type SIDE_DRAWER_ELEMENTS = 'logout' | 'manage_species' | 'manage_projects' | 'additional_data' | 'offline_map' | 'data_explorer' | 'activity_log' | 'inventory' | 'language' | 'delete' | 'guide' | 'notification' | 'features' | 'feedback' | 'forms' | 'intervention_tour'
